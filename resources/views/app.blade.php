...
<head>
<meta carset="UTF-8">
<div class="head">@yield('header')</div>
<div class="title">@yield('c1')</div>
<style>
<!--
This style sheet is not mine, it is from get bootstrap.com/examples/starter-template
was discussed in When You Want a View Partial to Always Receive Data
in laravel 5 fundamentals
-->
html {
...
<!-- ---||end of style sheet||--- -->
<div class="container">@yield('selectStyle')</div>
</head>
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="/">Partfolio 3</a>
			</div>

			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					<li><a href="/about">About</a></li>
					<li><a href="/welcome">Data</a></li>
					<li><a href="/aboutLaravel">About Laravel</a></li>
				</ul>
			</div>
			<!--/.nav-collapse -->
		</div>
	...
	<div class="container">@yield('navigation')</div>
	<div class="container">@yield('c2')</div><!-- this is the body -->
